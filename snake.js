// this set up is just particular to the chunk and how it needs to be set up
// this info can usually be found in the readme of the library
//can download beautify (something like that) to auto-format

// create snake
var draw = function(snakeToDraw, apple) {
  var drawableSnake = { color: "#196F3D", pixels: snakeToDraw };
  var drawableApple = { color: "#CB4335", pixels: [apple] };
